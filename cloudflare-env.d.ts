/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 556e48694d5456a253ae08519265105a)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	GITHUB_CONTRIBUTIONS_KV: KVNamespace;
	ASSETS: Fetcher;
	NEXT_PUBLIC_MY_EMAIL: string;
	NEXT_PUBLIC_SENDGRID_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_MY_EMAIL" | "NEXT_PUBLIC_SENDGRID_KEY" | "GITHUB_API_KEY" | "GITHUB_USER_NAME" | "KV_URL" | "KV_REST_API_URL" | "KV_REST_API_TOKEN" | "KV_REST_API_READ_ONLY_TOKEN">> {}
}
